...
if __name__ == "__main__":
    files_to_run = [
        ("mafft-I20260307-112630-0416-37035074-p2m.aln-fasta", "MAFFT"),
        ("muscle-I20260307-120859-0445-73032013-p1m.aln-fasta", "MUSCLE"),
        ("tcoffee-I20260307-121026-0089-69340585-p1m.aln-fasta", "T-COFFEE")
    ]
