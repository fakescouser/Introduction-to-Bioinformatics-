...
if __name__ == "__main__":
    files_to_run = [
        ("mafft_default.aln-fasta", "MAFFT Default"),
        ("mafft-customnew.aln-fasta", "MAFFT Custom"),
        ("mafft_new1.aln-fasta", "MAFFT Custom"),
        ("muscle_defaultnew.aln-fasta", "MUSCLE Default"),
        ("muscle_customfirst.aln-fasta", "MUSCLE First"),
        ("muscle_customsecond.aln-fasta", "MUSCLE Second"),
        ("tcoffee_defaultnew.aln-fasta", "T-COFFEE Default"),
        ("tcoffee_blosum_alligned_costum.aln-fasta", "T-COFFEE Blosum Alligned"),
        ("tcoffee_pam_input.aln-fasta", "T-COFFEE PAM Input")
    ]
